...
$$
\begin{align*}
\text{ODDS}(\text{DRINKING_D}=1) = \beta_{0} &+ \beta_{1} \times \text{FATAL_OR_M} + \beta_{2} \times \text{OVERTURNED} \\
&+ \beta_{3} \times \text{CELL_PHONE} + \beta_{4} \times \text{SPEEDING} \\
&+ \beta_{5} \times \text{AGGRESSIVE} + \beta_{6} \times \text{DRIVER1617} \\
&+ \beta_{7} \times \text{DRIVER65PLUS} + \beta_{8} \times \text{PCTBACHMOR} \\
&+ \beta_{9} \times \text{MEDHHINC} + \varepsilon
\end{align*}
$$
...
p &= P(\text{DRINKING_D}=1) \\
  &= \frac{1}{1 + e^{-(\beta_{0} + \beta_{1} \times \text{FATAL_OR_M} + \beta_{2} \times \text{OVERTURNED} + \ldots + \beta_{9} \times \text{MEDHHINC})}} \\
  &= \frac{1}{1 + e^{-\left(\beta_{0} + \sum_{i=1}^{9} \beta_{i} \times X_{i}\right)}}
\end{align*}
$$
